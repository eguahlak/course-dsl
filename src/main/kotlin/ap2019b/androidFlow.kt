...
fun Course.androidFlow() =    flow("Android") {
  ...
  week(49) {
    lecture("Basics of native Android app") {
      ability("the architecture of mobile devices in general", true)
      skill("simple android apps with multiple activities")
      read("TBD", 2.0)
      ...
      presentation("$slideRoot/08-android/08-android-handouts.pdf")
      }
    lecture("Connecting an app to the internet") {
      ability("asynchronious programming of mobile devices", true)
      read("TBD", 2.0)
  ...
  week(50) {
    lecture("Android recap") {
      note = "Project 3"
      knowledge("performance issues and how to solve them, when working with small devices (IoT)")
